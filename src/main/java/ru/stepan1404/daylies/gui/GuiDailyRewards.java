...
public class GuiDailyRewards extends GuiScreen{
	...
	public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_){
		...
		for(int i = 1;i<day;i++){
			List<String> data1 = Arrays.asList(allItems.get(day-i-1).split(":"));
			String materialName1 = data1.get(1) + ":" + data1.get(2);
			int amount1 = Integer.valueOf(data1.get(0));
			int damage1 = 0;
			if(data1.size()==4)
			damage1 = Integer.valueOf(data1.get(3));
			checkName(materialName1);
			//System.out.println(materialName1);
			if(isBlock){
	        	itemRenderer.renderItemAndEffectIntoGUI(this.mc.fontRenderer, this.mc.getTextureManager(), new ItemStack(getBlock(materialName1), amount1, damage1), this.width/2 - 50*i - 18, this.height/2-8);
	        	itemRenderer.renderItemOverlayIntoGUI(this.mc.fontRenderer, this.mc.getTextureManager(), new ItemStack(getBlock(materialName1), amount1, damage1), this.width/2 - 50*i - 18, this.height/2-8);
	        	isBlock = false;
	        } else 
	        if(isItem){
	        	itemRenderer.renderItemAndEffectIntoGUI(this.mc.fontRenderer, this.mc.getTextureManager(), new ItemStack(getItem(materialName1), amount1, damage1), this.width/2 - 50*i - 18, this.height/2-8);
	        	itemRenderer.renderItemOverlayIntoGUI(this.mc.fontRenderer, this.mc.getTextureManager(), new ItemStack(getItem(materialName1), amount1, damage1), this.width/2 - 50*i - 18, this.height/2-8);
	        	isItem = false;
	        }
		}
		...
		for(int i = day,o = 1;i<7;i++, o++){
			...
			//System.out.println(materialName1);
			if(isBlock){
	        	itemRenderer.renderItemAndEffectIntoGUI(this.mc.fontRenderer, this.mc.getTextureManager(), new ItemStack(getBlock(materialName1), amount1, damage1), this.width/2 + 50*o + 1, this.height/2-8);
	        	itemRenderer.renderItemOverlayIntoGUI(this.mc.fontRenderer, this.mc.getTextureManager(), new ItemStack(getBlock(materialName1), amount1, damage1), this.width/2 + 50*o + 1, this.height/2-8);
	        	isBlock = false;
	        } else 
	        if(isItem){
	        	itemRenderer.renderItemAndEffectIntoGUI(this.mc.fontRenderer, this.mc.getTextureManager(), new ItemStack(getItem(materialName1), amount1, damage1), this.width/2 + 50*o + 1, this.height/2-8);
	        	itemRenderer.renderItemOverlayIntoGUI(this.mc.fontRenderer, this.mc.getTextureManager(), new ItemStack(getItem(materialName1), amount1, damage1), this.width/2 + 50*o + 1, this.height/2-8);
	        	isItem = false;
	        }
		}
		RenderHelper.disableStandardItemLighting();
        GL11.glDisable(GL12.GL_RESCALE_NORMAL);
        this.drawString(this.fontRendererObj, EnumChatFormatting.GOLD + "\u0415\u0436\u0435\u0434\u043d\u0435\u0432\u043d\u044b\u0435 \u043d\u0430\u0433\u0440\u0430\u0434\u044b", this.width/2 - this.fontRendererObj.getStringWidth("\u0415\u0436\u0435\u0434\u043d\u0435\u0432\u043d\u044b\u0435 \u043d\u0430\u0433\u0440\u0430\u0434\u044b")/2, 70, -1);
		this.drawString(this.fontRendererObj, "\u041f\u043e\u043b\u0443\u0447\u0438\u0442\u0435 \u0438 \u0440\u0430\u0441\u043f\u0438\u0448\u0438\u0442\u0435\u0441\u044c\u0021", this.width/2 - this.fontRendererObj.getStringWidth("\u041f\u043e\u043b\u0443\u0447\u0438\u0442\u0435 \u0438 \u0440\u0430\u0441\u043f\u0438\u0448\u0438\u0442\u0435\u0441\u044c\u0021")/2, this.height/2 + 70, -1);
